...
$lang = array_merge($lang, array(
	...
	'GROUPEMAILER_UNSUB_TEXT'	=> 'Bonjour %1$s, vous ne recevrez plus les emails d\'information du forum %2$s. Votre compte devient inactif pour nos envois groupés, mais vous conservez l\'accès au forum et pouvez continuer à participer normalement.',
	...
	'ACP_GROUPEMAILER_UNSUBS'	=> 'Désabonnements',
	'GROUPEMAILER_UNSUBS_LEGEND'	=> 'Membres désabonnés',
	'GROUPEMAILER_UNSUBS_EXPLAIN'	=> 'Membres ayant utilisé le lien de désabonnement reçu dans un email. Ils ne recevront plus aucune campagne tant que la préférence « Recevoir les emails de masse » reste désactivée dans leur profil. Un membre s\'étant désabonné plusieurs fois n\'apparaît qu\'une fois, à la date la plus récente.',
	'GROUPEMAILER_UNSUBS_TOTAL'	=> 'Nombre de membres désabonnés',
	'GROUPEMAILER_UNSUBS_CAMPAIGN'	=> 'Depuis la campagne',
	'GROUPEMAILER_UNSUBS_DATE'	=> 'Date du désabonnement',
	'GROUPEMAILER_UNSUBS_NONE'	=> 'Aucun membre ne s\'est désabonné.',
	'GROUPEMAILER_UNSUBS_BACK'	=> 'Réabonné depuis',
	'GROUPEMAILER_UNSUBS_RESUB'	=> 'Réabonner',
	'GROUPEMAILER_RESUB_ADMIN_DONE'	=> 'Membre réabonné : il recevra de nouveau les campagnes. À ne faire qu\'à sa demande explicite, un réabonnement non sollicité conduisant souvent au signalement du message comme indésirable.',
	'GROUPEMAILER_UNSUB_NOTIFY_LEGEND'	=> 'Désabonnements',
	'GROUPEMAILER_UNSUB_NOTIFY_EXPLAIN'	=> 'Ce qui se passe lorsqu\'un membre utilise le lien de désabonnement reçu dans un email.',
	'GROUPEMAILER_UNSUB_CONFIRM'	=> 'Accusé au membre',
	'GROUPEMAILER_UNSUB_CONFIRM_LABEL'	=> 'Envoyer un accusé de désabonnement au membre',
	'GROUPEMAILER_UNSUB_CONFIRM_EXPLAIN'	=> 'Le membre reçoit un email confirmant la prise en compte de sa demande, avec sa date, et précisant que son compte devient inactif pour les envois groupés, sans que son accès au forum soit remis en cause. Cet accusé évite les demandes de confirmation adressées ensuite à l\'administration.',
	'GROUPEMAILER_UNSUB_NOTIFY_WHO'	=> 'Administrateur informé',
	'GROUPEMAILER_UNSUB_NOTIFY_NONE'	=> 'Personne',
	'GROUPEMAILER_UNSUB_NOTIFY_NOMAIL'	=> 'sans adresse email',
	'GROUPEMAILER_UNSUB_NOTIFY_WHO_EXPLAIN'	=> 'Fondateurs et membres du groupe Administrateurs. Une seule personne est informée, afin d\'éviter que chaque désabonnement ne génère plusieurs messages.',
	'GROUPEMAILER_UNSUB_NOTIFY_HOW'	=> 'Mode de notification',
	'GROUPEMAILER_UNSUB_NOTIFY_BY_EMAIL'	=> 'Par email',
	'GROUPEMAILER_UNSUB_NOTIFY_BY_PM'	=> 'Par message privé',
	'GROUPEMAILER_UNSUB_NOTIFY_HOW_EXPLAIN'	=> 'La notification indique le membre concerné, son adresse, la date et la campagne à l\'origine du départ. Sur un forum où les désabonnements sont fréquents, mieux vaut n\'en activer aucun et consulter la page Désabonnements de temps à autre.',
	'GROUPEMAILER_UNSUB_PM_SUBJECT'	=> 'Désabonnement d\'un membre',
	'GROUPEMAILER_UNSUB_PM_BODY'	=> 'Un membre vient de se désabonner des envois groupés du forum.\n\nMembre : %1$s\nAdresse : %2$s\nDate : %3$s\nCampagne à l\'origine du désabonnement : %4$s\n\nCe membre n\'apparaîtra plus dans les destinataires des prochaines campagnes.',
	'GROUPEMAILER_UNSUB_MAIL_SUBJECT'	=> 'Confirmation de votre désabonnement',
	'GROUPEMAILER_UNSUB_MAIL_DEFAULT'	=> 'Bonjour {USERNAME},
Votre demande de désabonnement a bien été enregistrée le {UNSUB_DATE}.
Vous ne recevrez plus aucun email d\'information envoyé par l\'administration du forum {SITENAME}.
Votre compte deviendra inactif pour l\'ensemble de nos envois groupés et du forum.
Si vous changez d\'avis, vous pouvez réactiver ces envois à tout moment depuis votre compte, rubrique « Panneau de l\'utilisateur » puis « Préférences » : 
{U_PREFS}
Ce message est un accusé de réception automatique, il n\'appelle aucune réponse.',
	'GROUPEMAILER_UNSUB_TEXT_LABEL'	=> 'Texte de l\'accusé',
	'GROUPEMAILER_UNSUB_TEXT_EXPLAIN'	=> 'Laissez vide pour employer le texte par défaut, affiché en filigrane dans le champ. Les marqueurs {USERNAME}, {SITENAME}, {UNSUB_DATE} et {U_PREFS} sont remplacés à l\'envoi respectivement par le pseudonyme du membre, le nom du forum, la date du désabonnement et l\'adresse de ses préférences.',
	'GROUPEMAILER_UNSUBS_RESENT'	=> 'Accusé renvoyé le',
	'GROUPEMAILER_UNSUBS_RESEND'	=> 'Renvoyer l\'accusé',
	'GROUPEMAILER_UNSUB_RESEND_DONE'	=> 'Accusé de désabonnement renvoyé à %1$s le %2$s.',
	'GROUPEMAILER_UNSUB_RESEND_FAILED'	=> 'Le renvoi a échoué. Vérifiez que l\'accusé au membre est activé dans les Réglages et que l\'adresse du membre est valide.',
	'GROUPEMAILER_STATUS_LEFT_GROUP'	=> 'Hors groupes',
	'GROUPEMAILER_LEFT_GROUP_NOTE'	=> 'N\'appartient plus aux groupes ciblés : non relancé',
	'GROUPEMAILER_EXCLUDED_LEFT_GROUP'	=> '%d destinataire(s) n\'appartiennent plus aux groupes ciblés par la campagne d\'origine : ils ne sont pas relancés, mais restent au tableau de suivi afin de ne pas fausser les statistiques.',
	'GROUPEMAILER_DIAG_UNSUB_NOTIFY'	=> 'Copie des désabonnements',
	'GROUPEMAILER_DIAG_UNSUB_NOBODY'	=> 'Aucun administrateur sélectionné : aucune copie n\'est envoyée. Choisissez un destinataire dans les Réglages.',
	'GROUPEMAILER_DIAG_UNSUB_NO_MODE'	=> 'aucun mode d\'envoi coché',
));
